    ...
    <form id="formId" action="" method="post" >
        <table width="400px" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td>
                    <input id="userId" name="userName" value="${stu.stuName}" onBlur="userNameBlur()"/>
            ...
            <tr>
                <td>学号：</td>
                <td>
                    <input id="stuCodeId" name="code" value="${stu.stuCode}" onBlur="codeBlur()"/>
            ...
            <tr>
                <td>开学时间:</td>
                <td>
                    <input id="postTime" type="date" value="${stu.beginTime}" name="PostTime" onBlur="timeBlur()"/>
